...
<html>
    ...
    <body>
        <div class="content">
            ...
            <div class="text">
                <h2>The page you've requested <span>can't be found</span>.</h2>
                <h3 title="404">The page you are looking for could have changed name, have been removed or been temporarily unavailable.</h3>
                <p>

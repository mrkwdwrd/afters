              ...
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tbody>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Volte, Helvetica, sans-serif;font-size:28px;font-weight:600;line-height:1;text-align:left;color:#333333;">Order Confirmation</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Volte, Helvetica, sans-serif;font-size:16px;line-height:24px;text-align:left;color:#333333;">Hi, {!! $order->user ? $order->user->first_name : $order->shippingAddress->first_name !!}!</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Volte, Helvetica, sans-serif;font-size:16px;line-height:24px;text-align:left;color:#333333;">
                          <p>Thank you for your order!</p> @if($order->user) <p>If you want to view it online, you can do so <a href="{!! url('/account/orders/' . $order->token . '/show') !!}">here after logging in</a>.</p> @endif
                        </div>
                      </td>
                    </tr>
                    <tr>
